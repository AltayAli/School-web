...
let FormCreater = {
    CreateForm: function (model, isCreate) {
        var key = model != null ? model["user_guid"] : "";
        ...
        $("#form").on("submit", function (e) {
            ...
            let url = isCreate ? `${Model.RegisterUserUrl}/registeradminuser` : `${Model.UsersUrl}/edit/${key}`;
            Model.SendRequest(`/api/post?url=${url}&check=1&origin=2`,"POST", true, JSON.stringify(model))
                .then(() => {
